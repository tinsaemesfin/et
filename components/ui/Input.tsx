...
export const inputClasses =
  "w-full rounded-md border border-black/10 dark:border-white/20 bg-white/70 dark:bg-black/30 px-3 py-2 text-sm placeholder:text-black/50 dark:placeholder:text-white/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--color-brand]";
